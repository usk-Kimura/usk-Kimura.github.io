...
export const publications: Publication[] = [
  ...
  },
  {
    ...
    selected: true,
    selectedReason: {
      ja: 'IEEE ICDEW 査読付き論文',
      en: 'Peer-reviewed IEEE ICDEW paper',
      zh: 'IEEE ICDEW 同行评审论文',
      ko: 'IEEE ICDEW 동료 심사 논문',
    },
  ...
  },
  {
    ...
    selectedReason: {
      ja: '筆頭著者・査読付き国際ジャーナル',
      en: 'First-author peer-reviewed journal article',
      zh: '第一作者、同行评审国际期刊论文',
      ko: '제1저자·동료 심사 국제 학술지 논문',
    },
  ...
  },
  {
    ...
    selected: true,
    selectedReason: {
      ja: '筆頭著者・国際会議論文 (SoICT)',
      en: 'First-author international conference paper (SoICT)',
      zh: '第一作者、国际会议论文（SoICT）',
      ko: '제1저자·국제 학회 논문(SoICT)',
    },
