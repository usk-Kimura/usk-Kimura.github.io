...
export const ko: UiStrings = {
  ...
  sections: {
    ...
    publications: '논문',
    researchOutputs: '연구 실적',
    archivalPublications: '논문 및 프로시딩',
    posterPresentations: '포스터 발표',
    awards: '수상',
    career: '경력',
    education: '학력',
    grants: '연구 지원',
  ...
  labels: {
    ...
    filter: '유형',
    all: '전체',
    olderPublications: '이전 논문 및 프로시딩 보기',
  ...
  counts: {
    publications: '총 {n}편',
    presentations: '총 {n}건',
    researchOutputs: '논문 및 프로시딩 {publications}편 / 포스터 발표 {posters}건',
    matching: '연구 실적 {m}건 중 {n}건 일치',
    awards: '총 {n}건',
    activities: '총 {n}건',
    older: '{n}편',
  },
  ...
  actions: {
    seeAllResearchOutputs: '연구 실적 전체 보기',
    seeAllPublications: '논문 및 프로시딩 전체 보기',
    viewCv: '이력서(CV) 보기',
    contactMe: '연락하기',
    backToPublications: '연구 실적 목록으로 돌아가기',
    backHome: '홈으로 돌아가기',
  },
  pubTypes: {
    journal: '학술지',
